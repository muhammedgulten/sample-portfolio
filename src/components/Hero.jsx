        ...
        <div className='flex flex-wrap lg:flex-row-reverse'>
            <div className='w-full lg:w-1/2'>
                <div className='flex justify-center lg:p-8'>
                    <motion.img src={profilePic} alt="Muhammed G." className='border border-stone-900 rounded-3xl' 
            ...
            <div className='w-full lg:w-1/2'>
                ...
                className='flex flex-col items-center lg:items-start mt-10'>
                    <motion.h2 variants={childVariants} className='pb-2 text-4xl tracking-tighter lg:text-8xl'>Muhammed G.</motion.h2>
